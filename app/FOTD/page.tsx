  ...
  return (
    ...
    >
      ...
      <div className="absolute top-6 right-6 z-20 flex gap-4">
        ...
        >
          <img src="/Twitter.png" alt="X/Twitter" className="w-full h-full object-cover" />
        </a>
        <a
          href="https://pump.fun/"
          target="_blank"
          ...
          style={{ boxShadow: '0 0 20px rgba(106, 188, 58, 0.5)' }}
        >
          <img src="/Pumpfun.png" alt="Pump.fun" className="w-full h-full object-cover" />
        </a>
      </div>
      ...
      <div className="relative z-10 max-w-4xl w-full flex flex-col items-center gap-8">
        ...
        {/* Timer Display */}
        <div className="w-full max-w-md bg-gray-800 p-6 rounded-xl border-4 border-gray-700" style={{ boxShadow: '0 0 30px rgba(106, 188, 58, 0.6)' }}>
        ...
        {isLoading ? (
          ...
          <div className="w-full max-w-md bg-gray-800 p-6 rounded-xl border-4 border-gray-700" style={{ boxShadow: '0 0 30px rgba(106, 188, 58, 0.6)' }}>
            ...
            {/* Rarity Score */}
            <div className="bg-black p-4 rounded-md border border-gray-900 mb-4">
              <p
              ...
              >
                {fotdData.currentFrog.rarity.rank}
              </p>
            </div>
          ...
          <div className="w-full max-w-md bg-gray-800 p-8 rounded-xl border-4 border-gray-700" style={{ boxShadow: '0 0 30px rgba(106, 188, 58, 0.6)' }}>
        ...
        {/* Prize Info */}
        <div className="w-full max-w-md bg-gray-800 p-6 rounded-xl border-4 border-gray-700" style={{ boxShadow: '0 0 30px rgba(255, 215, 0, 0.4)' }}>
          <p className="text-yellow-400 text-center text-sm leading-relaxed" style={{ fontFamily: "'Press Start 2P', cursive" }}>
            WINNER GETS 25% OF TREASURY!
          </p>
        </div>
      </div>
    </main>
